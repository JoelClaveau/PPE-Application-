...
public class VueProfil extends JPanel implements ActionListener, KeyListener
{
	...
	public VueProfil()
	{
		...
		this.txtIdentifiant.addKeyListener(this);
	...
	{
		String identifiant = this.txtIdentifiant.getText(); // on recupere le pseudo
		String mdp = new String(this.txtMdp.getPassword());
		Profil unProfil = Modele.verifConnexion(identifiant, mdp);
		if(unProfil == null)
		{
